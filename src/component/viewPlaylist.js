...
export default function ViewPlaylist (){
    ...
    const [topArt, setTopArt ] = useState({items : [ {name : "", images : [{url : ''}]} ], name : "", images : [{url : ''}]})
        ...
        <div className="">
            ...
            <div className="body">
                <div >
                    ...
                    <div>
                    <Track indece={'1'} trackName={'track.name'} artists={'artiste kaka'} album={'getAlbum.name'} key={'track.id'}/>
                    ...
                    {topArt.items ? topArt.items.map((track, index)=> <Track indece={index + 1} trackName={track.name} artists={track.artists[0].name} album={' '} key={track.id}/>) : <span>Echecs</span>}
                    </div>
                </div>
